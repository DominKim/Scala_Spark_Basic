...
object Step02_method_special {
  ...
  // 정의 & 호출
  ((x : Int, y : Int) => println("any func = " + x * y))(10, 20)
  ...
  println("any_func2 = " + any_func2(10, 20)) // any_func2 = 200
  
  // 일반함수 -> 익명함수 + 함수 축소기법
  val any_func3 : (Int, Int) => Int = _ * _
  
  println("any_func3 = " + any_func3(10, 20)) // any_func3 = 200
  ...
  def textPro(texts : Array[String]) : Unit = {
    println("texts size = " + texts.size) // texts size = 4
