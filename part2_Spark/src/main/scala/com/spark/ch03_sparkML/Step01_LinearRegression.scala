...
import org.apache.spark.sql.SparkSession // DataFrame spark object
...
object Step01_LinearRegression {
  ...
  def main(args: Array[String]): Unit = {
    ...
    dataset.show(150, false) // .show(false) : 전체 컬럼 모두 보기
    /*
     * +-----+-------------------------------+
     * |label|features                       |
     * +-----+-------------------------------+
    ...
    print(s"r2 score : ${model_summary.r2}\n") // 비정규화
    print(s"MSE : ${model_summary.meanSquaredError}\n") // 정규화
